  ...
  return (
    <div className="max-w-7xl  mx-auto px-4 sm:px-6 lg:px-12 mt-20 py-10 flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="md:w-1/2 text-center md:text-left" >
        ...
        <h1 className="text-3xl  sm:text-4xl md:text-3xl lg:text-5xl font-bold leading-tight mt-2"  id="typewriter">
      ...
      <div className="md:w-1/2 relative flex justify-center">
        ...
        >
          ...
          <img src={blog_img} alt="Blog Hero" className="rounded-[50px] w-full" />
        </motion.div>
